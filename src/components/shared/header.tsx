    ...
    >
      <div className="container mx-auto flex items-center justify-between px-4 md:px-6">
        ...
        >
          ...
          <span className="text-lg font-bold font-headline text-left">
        ...
        <nav className="hidden md:flex items-center gap-6 text-sm font-medium">
          ...
          <Button
            ...
            onClick={(e) => scrollTo("events", e as any)}
          >
              ...
              <SheetContent side="right">
                <div className="flex flex-col h-full -mx-6 -my-6">
                  <SheetHeader className="p-4 border-b">
                    <SheetTitle className="text-lg font-bold font-headline text-left">
                      Menu
                    </SheetTitle>
                  </SheetHeader>
                  <nav className="flex-1 flex flex-col gap-2 p-4">
                    {navLinks.map((link) => (
                      <NavLink key={link.name} href={link.href} isMobile={true}>
                        {link.name}
                      </NavLink>
                    ))}
                  </nav>
